-- =============================================================================
-- OA Manager v1 — 더미 데이터 (개발/테스트용 · ⚠ 2026-06-14 폐기)
--
-- 본 파일은 변경후 자산번호 형식(BDT00001 등)을 사용합니다.
-- 2026-06-14 자산번호 형식을 옛 기준(D00001 등) 단일로 통일하면서
-- 이 파일의 INSERT는 CHECK/trigger에 의해 모두 실패합니다.
-- 새 환경에서는 다른 시드 스크립트를 사용하세요.
-- =============================================================================
\echo '!!! dummy_data.sql is deprecated — uses old "변경후" UID format (BDT00001).'
\echo '!!! It will fail current asset_uid CHECK. Use another seed.'
\quit
-- =============================================================================
